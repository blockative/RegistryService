...
contract NamingService is ERC721URIStorage {
    ...
    function register(string calldata name) public payable {
        ...
        require(msg.value >= _price, "Insufficent balance");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Blockchain Naming Service", "image": "data:image/svg+xml;base64,',
